...
func TestRun_TheInvalidRunNoteNamesTheConfiguredLimit(t *testing.T) {
	...
	if !strings.Contains(text, "every response of "+bigMethod+" was larger than max_response_size (1MiB): raise it") || strings.Contains(text, "4MiB") {
